...
def test_quarantaine_ecrite_en_parquet_partitionne_sur_la_date_mesuree(monkeypatch, capsys):
    ...
    s3 = FakeS3()
    monkeypatch.setattr(quality.storage, "get_s3", lambda: s3)
    s3.seed_bronze("SITE001/2025-01-01/000000.json", {"timestamp": "2025-01-01T05:00:00"})  # pas de site_id
    ...
    assert list(s3.parquet("quarantine", cles[0]).columns) == quality.QUARANTINE_COLUMNS
